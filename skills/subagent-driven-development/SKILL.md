...
Always dispatch subagents on the most capable available model. Do not downgrade implementers, reviewers, or any other role to a cheaper or faster model — the cost of a subtle mistake in an autonomous subagent (silent bad implementation, missed review issue, wrong judgment call) far outweighs the token savings. Subagents work without your oversight; give them the strongest reasoning available.
